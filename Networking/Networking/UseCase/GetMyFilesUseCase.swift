...
extension Service {
    ...
    public func getUserFiles(completion: @escaping (Result<[MyFileEntity], Error>) -> Void) {
        
        let url = URL(string: "http://localhost:8080/api/v1/files/user")!
